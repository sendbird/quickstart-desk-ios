//
//  SBDSKIncomingUserMessageTableViewCell.m
//  QuickStart
//
...
@interface SBDSKIncomingUserMessageTableViewCell()
...
@implementation SBDSKIncomingUserMessageTableViewCell
...
- (void)setModel:(SBDUserMessage *)model {
    ...
    self.messageTextView.linkTextAttributes = @{
                                                NSForegroundColorAttributeName: [UIColor colorNamed:@"color_incoming_user_message_link"],
...
- (NSAttributedString *)buildNickname:(NSString *)nickname {
    NSDictionary *nicknameAttributes = @{
                                         ...
                                         NSForegroundColorAttributeName: [UIColor colorNamed:@"color_incoming_user_message_nickname"],
                                         };
...
- (NSAttributedString *)buildMessage:(NSString *)message {
    NSDictionary *messageAttributes = @{
                                        ...
                                        NSForegroundColorAttributeName: [UIColor colorNamed:@"color_incoming_user_message_text"],
                                        };
...
- (NSAttributedString *)buildMessageDate:(NSString *)plainDate {
    NSDictionary *messageDateAttributes = @{
                                            ...
                                            NSForegroundColorAttributeName: [UIColor colorNamed:@"color_incoming_user_message_date"],
                                            };
